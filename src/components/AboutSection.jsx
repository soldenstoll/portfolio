      ...
      <div className="flex min-h-90 flex-col gap-2">
          ...
          <PhotoTextPair img="/images/allen-school-logo.jpeg" height={"128px"} padding={"20px"}>
            <div className="flex flex-col text-left">
              ...
              <p className="text-base">
                Relavent coursework in Data Structures, Algorithms, Database Internals, Systems Programming,
              ...
              <p className="text-base">
                Honors: GPA - 3.9, Putnam Exam - scored 13, ranked 820/3988. Deans List 11/11 quarters. 
              </p>
            </div>
          </PhotoTextPair>
        </div>
        <div className="flex w-full min-h-16 border-[2px] border-[var(--grid-line-color)] rounded-lg">
          <div className="flex flex-col text-left w-full p-5">
            ...
            <p className="text-base">Software: Linux, Github/Gitlab, Bitbucket, Azure, VS Code, IntelliJ, Google Colab, Google Cloud, MS Office</p>
          </div>
        </div>
      </div>
    </div>
